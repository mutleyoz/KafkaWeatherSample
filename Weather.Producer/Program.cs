...
namespace Weather.Producer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if(producer != null)
            {
                var weatherRecord = new WeatherRecord { City = WeatherCities.Sydney, GmtOffset = 11, Type = WeatherTypes.Rainy, Humidity = 100, Temperature = 17, WindSpeed = 20 };

                producer.Send("weatherrecord", weatherRecord);
            }
        }
    }
}
